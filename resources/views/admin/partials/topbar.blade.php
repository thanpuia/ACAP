        ...
        <ul class="nav-right">
            <li>
                ...
                <span class="icon-holder">
                    <i class="c-yellow-700 ti-filter"></i>
                    </span>
                    <span class="title">Filter</span>
                </a>

                <!-- Modal -->
                <div class="modal fade bd-example-modal-lg" data-backdrop="false"id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
